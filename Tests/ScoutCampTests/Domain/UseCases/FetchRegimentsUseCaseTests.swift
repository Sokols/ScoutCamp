...
final class FetchRegimentsUseCaseTests: XCTestCase {

    func testFetchRegimentsUseCase_whenSuccess_thenListIsReturned() async throws {
        // given
    ...
    func testFetchRegimentsUseCase_whenFailure_thenErrorIsReturned() async throws {
        // given
