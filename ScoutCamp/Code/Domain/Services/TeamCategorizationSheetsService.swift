...
protocol TeamCategorizationSheetsServiceProtocol {
    func getTeamCategorizationSheets(for teamId: String) async -> ResultArray<TeamSheetDTO>
    func createUpdateTeamSheet(_ sheet: TeamSheet) async -> ResultObject<String>
}
