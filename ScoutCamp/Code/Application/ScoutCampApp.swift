...
struct ScoutCampApp: App {
    ...
    @StateObject private var categorizationSheetAssignmentsService = CategorizationSheetAssignmentsService()
    @StateObject private var categorizationAssignmentsService = CategorizationAssignmentsService()
    @StateObject private var sheetTypesService = SheetTypesService()
    @StateObject private var assignmentCategoriesService = AssignmentCategoriesService()
    ...
    var body: some Scene {
        WindowGroup {
            ContentView()
                ...
                .environmentObject(categorizationSheetAssignmentsService)
                .environmentObject(categorizationAssignmentsService)
                .environmentObject(sheetTypesService)
                .environmentObject(assignmentCategoriesService)
